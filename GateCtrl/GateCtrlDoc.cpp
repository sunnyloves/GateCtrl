...
void CGateCtrlDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CGateCtrlDoc::InitializeSearchContent()
{
...
void CGateCtrlDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
