...
BOOL CParaConfigDlg::OnInitDialog()
{
	...
	//串口选择
	CMFCPropertyGridProperty* pProp0 = new CMFCPropertyGridProperty(_T("串口"), _T("COM1"),_T("选择通讯用的串口"));
...
*/
	...
	CMFCPropertyGridProperty* pProp101 = new CMFCPropertyGridProperty(_T("闸内水位站名称"), _T(""), _T("设定闸内水位站名称"));
	pProp10->AddSubItem(pProp101);

	CMFCPropertyGridProperty* pProp102 = new CMFCPropertyGridProperty(_T("闸内水位站零点(cm)"), (_variant_t)0.0, _T("设定闸内水位站零点(cm)"));
	pProp10->AddSubItem(pProp102);

	CMFCPropertyGridProperty* pProp103 = new CMFCPropertyGridProperty(_T("闸内水位站站号"), _T("1"), _T("设定闸内水位站通讯站号"));
	...
	CMFCPropertyGridProperty* pProp201 = new CMFCPropertyGridProperty(_T("闸外水位站名称"), _T(""), _T("设定闸外水位站名称"));
	pProp20->AddSubItem(pProp201);

	CMFCPropertyGridProperty* pProp202 = new CMFCPropertyGridProperty(_T("闸外水位站零点(cm)"), (_variant_t)0.0, _T("设定闸外水位站零点(cm)"));
	pProp20->AddSubItem(pProp202);

	CMFCPropertyGridProperty* pProp203 = new CMFCPropertyGridProperty(_T("闸外水位站站号"), _T("1"), _T("设定闸外水位站通讯站号"));
	...
	CMFCPropertyGridProperty* pProp3 = new CMFCPropertyGridProperty(_T("闸门开启水位差(cm)"), (_variant_t)0.0, _T("闸门开启水位差(cm)"));
...
void CParaConfigDlg::OnBnClickedOk()
{
	...
	m_ConfigXml.AddElem(_T("串口"));
	m_ConfigXml.AddChildElem(_T("com1"));

	m_ConfigXml.AddElem(_T("水位站"));
	m_ConfigXml.AddChildElem(_T("闸内水位站"));
	m_ConfigXml.IntoElem();
	m_ConfigXml.AddChildElem(_T("闸外水位站名称"),_T(" "));
	m_ConfigXml.AddChildElem(_T("闸外水位站零点(cm)"),_T("0.0"));
	m_ConfigXml.AddChildElem(_T("闸外水位站站号"),_T("1"));

	m_ConfigXml.OutOfElem();
	m_ConfigXml.AddChildElem(_T("闸内水位站"));
	m_ConfigXml.IntoElem();
	m_ConfigXml.AddChildElem(_T("闸内水位站名称"),_T(" "));
	m_ConfigXml.AddChildElem(_T("闸内水位站零点(cm)"),_T("0.0"));
	m_ConfigXml.AddChildElem(_T("闸内水位站站号"),_T("2"));


	m_ConfigXml.OutOfElem();
	m_ConfigXml.AddElem(_T("闸门开启水位差(cm)"),_T("0.0"));
